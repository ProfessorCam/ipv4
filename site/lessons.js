...
var LESSONS = [
  /* ------------------------------------------------------------------ bits */
  {
    ...
    sections: [
      ...
      { h: 'Powers of two', p: {
        s: [
          'Every time you add one more switch, the number of possible values doubles. This little table is worth remembering; it comes up on every row of this site.'
        ],
        m: [
  ...
  /* ------------------------------------------------------------------ mask */
  {
    ...
    sections: [
      ...
      { h: 'The masks you will meet', p: {
        ...
        e: [
          ['Prefix', 'Mask', 'Wildcard', 'Host bits', 'Addresses', 'Usable'],
          ['/8',  '255.0.0.0',       '0.255.255.255', '24', '2<sup>24</sup>', '2<sup>24</sup> − 2'],
          ['/16', '255.255.0.0',     '0.0.255.255',   '16', '2<sup>16</sup>', '2<sup>16</sup> − 2'],
          ...
          ['/31', '255.255.255.254', '0.0.0.1',       '1',  '2', '2 (RFC 3021)'],
